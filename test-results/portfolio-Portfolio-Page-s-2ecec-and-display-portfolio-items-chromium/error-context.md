...
- Name: Portfolio Page >> should load and display portfolio items
- Location: /home/tom/github/digitname/www/tests/portfolio.spec.js:28:3
...
Call log:
  - waiting for locator('#portfolio-loading') to be hidden
    35 × locator resolved to visible <div id="portfolio-loading">…</div>

    at /home/tom/github/digitname/www/tests/portfolio.spec.js:33:16
```
